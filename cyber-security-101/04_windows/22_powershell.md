...
| ↓ | |
| `Where-Object` | Filters processes with more than 10 seconds of CPU time |
| ↓ | |
| `Sort-Object` | Sorts them by CPU time from highest to lowest |
| ↓ | |
| `Select-Object` | Displays only the `Name` and `CPU` properties |
